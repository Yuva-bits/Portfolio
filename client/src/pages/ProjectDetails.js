            ...
            <div
              ...
              dangerouslySetInnerHTML={{ 
                __html: project.text
                  .replace(/<br\s*\/?>/gi, '')
                  .replace(/\n/g, '')
                  .replace(/<p class="project-subtitle">/g, '<p style="text-align: center; font-size: 1.35rem; font-weight: 600; margin: 1rem 0 0.75rem 0; padding: 0; color: white; font-family: \'Barlow\', \'Inter\', \'Segoe UI\', \'Roboto\', \'Helvetica Neue\', Arial, sans-serif;">')
                  ...
                  .replace(/<h1>/g, '<h1 style="font-size: 1.8rem; font-weight: 600; margin: 1rem 0 0.75rem 0; padding: 0; color: white; text-align: justify; font-family: \'Barlow\', \'Inter\', \'Segoe UI\', \'Roboto\', \'Helvetica Neue\', Arial, sans-serif;">')
                  .replace(/<h2>/g, '<h2 style="font-size: 1.6rem; font-weight: 600; margin: 1rem 0 0.75rem 0; padding: 0; color: white; text-align: justify; font-family: \'Barlow\', \'Inter\', \'Segoe UI\', \'Roboto\', \'Helvetica Neue\', Arial, sans-serif;">')
                  .replace(/<h3>/g, '<h3 style="font-size: 1.4rem; font-weight: 600; margin: 1rem 0 0.75rem 0; padding: 0; color: white; text-align: justify; font-family: \'Barlow\', \'Inter\', \'Segoe UI\', \'Roboto\', \'Helvetica Neue\', Arial, sans-serif;">')
